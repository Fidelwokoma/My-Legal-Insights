...
function changeprice(e) {
    if (btn_change.textContent == 'NGN'){
      ...
      textss.textContent = '₦ 3,119,375.00'
      text_tax.textContent = '₦ 0.00'
      
      total_price.textContent = '₦ 3,119,375.00'
    }
    else{
      btn_change.textContent = 'NGN'
      textss.textContent = '$ 2,500.00'
      text_tax.textContent = '$ 0.00'
      
      total_price.textContent = '$ 2,500.00'
    }
}